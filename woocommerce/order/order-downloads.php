...
<section class="woocommerce-order-downloads">
	<?php if ( isset( $show_title ) ) : ?>
		<h2 class="woocommerce-order-downloads__title"><?php esc_html_e( 'Downloads', 'online_mart' ); ?></h2>
	<?php endif; ?>
						...
						if ( has_action( 'woocommerce_account_downloads_column_' . $column_id ) ) {
							...
							switch ( $column_id ) {
								...
								case 'download-remaining':
									echo is_numeric( $download['online_mart'] ) ? esc_html( $download['online_mart'] ) : esc_html__( '&infin;', 'online_mart' );
									break;
